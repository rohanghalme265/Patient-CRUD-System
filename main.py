...
*It is typically used in HTTP methods such as POST or PUT to transmit structured data (e.g., JSON, XML) for
...
@app.get('/')
def hello():
    return {'message' : 'Patient Management System of Patient'}
